...
class BM25Retriever:
    def __init__(self):
        ...
        # self.output_dir = 'BM_Results_after_qe_thesauri/'
        self.output_dir = 'BM_Results_after_qe_PRF/'
        self.k1 = 1.2
        self.b = 0.75
        self.k2 = 100
...
def main():
    # expanded_queries_file = os.path.dirname(__file__) + "/Query Expansion/query_expanded_thesaurus.txt"
    expanded_queries_file = os.path.dirname(__file__) + "/Query Expansion/terms_for_expansion.txt"
